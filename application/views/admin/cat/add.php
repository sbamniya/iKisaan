<div id="wrapper">   
    <div id="page-wrapper">    
        <div class="container-fluid"> 
			...
			<div class="row">
				<div class="col-md-8">
					<form class="form-horizontal form-validate-jquery cat-add-form" method="post" action="<?php echo base_url(ADMIN_URL) ?>category/add-process" enctype="multipart/form-data">
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<input type="text" name="catName" class="form-control required" placeholder="<?php echo $this->lang->line('ENTER_CATEGORY_NAME') ?>" value="<?php echo set_value('catName'); ?>">
									</div>
								</div>
								<div class="form-group">
