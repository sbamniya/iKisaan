					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="text-right">
								<a href="<?php echo base_url(ADMIN_URL); ?>apps/multi-user" class="btn btn-primary"><?php echo $this->lang->line('BACK') ?></a>
							</div>						
						</div>
					</div>
				</div>
					...
					<div class="col-md-6">
						<div class="panel panel-flat">
							<div class="panel-body">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label"><?php echo $this->lang->line('TOTAL_FRIENDS') ?> <span class="text-danger">*</span>:</label>
									<div class="col-lg-9">
										<input type="number" name="totalFriends" class="form-control required" placeholder="<?php echo $this->lang->line('ENTER_TOTAL_FRIENDS') ?>" min="1" max="10">
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label"><?php echo $this->lang->line('SHOW_FRIEND_PROFILE_IMAGE') ?> <span class="text-danger">*</span>:</label>
									<div class="col-lg-9">
										<label class="radio-inline"><input type="radio" name="showFriendProfile" value="1" checked>Show</label>
										<label class="radio-inline"><input type="radio" name="showFriendProfile" value="0">Hide</label> 
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label"><?php echo $this->lang->line('PROFILE_FRIEND_IMAGE_BORDER') ?> <span class="text-danger">*</span>:</label>
									<div class="col-lg-9">
										<label class="radio-inline"><input type="radio" name="profileFriendImgBorder" value="0" checked>Rectangle</label>
										<label class="radio-inline"><input type="radio" name="profileFriendImgBorder" value="50%">Circle</label> 
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-3 control-label"><?php echo $this->lang->line('SHOW_FRIEND_NAME') ?> <span class="text-danger">*</span>:</label>
									<div class="col-lg-9">
										<label class="radio-inline"><input type="radio" name="showFriendName" value="1" checked>Show</label>
										<label class="radio-inline"><input type="radio" name="showFriendName" value="0">Hide</label> 
									</div>
								</div>
								<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-2">
									...
									<div class="user-name-container">
										<span class="draggable">Username</span>
