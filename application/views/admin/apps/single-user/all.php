			...
			<div class="row">
			    <div class="col-lg-12">
			        <h1 class="page-header">
			            <?php echo $this->lang->line('SINGLE_USER_APP_PAGE') ?>
			        </h1>
			        <ol class="breadcrumb">
			            <li class="active">
			                <i class="fa fa-film"></i>&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('SINGLE_USER_APP_PAGE') ?>
			            </li>
			        </ol>
			    </div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
						<div class="text-right">
							<a href="<?php echo base_url(ADMIN_URL); ?>apps/single-user/add"><button class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('ADD_NEW') ?></button></a>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
				<div class="table-responsive">
					<table class="datatable">
							...
							<tbody>
								<?php if(!empty($singleUserApps)) { 

									foreach ($singleUserApps as $key=>$app) { ?>
									<tr>
										...
										<td class="text-left">
											<a href="<?php echo base_url(ADMIN_URL) ?>app/single-user/edit/<?= $app->appSlug ?>"><i class="fa fa-edit"></i></a> | <?php if($app->appStatus!=1): ?>
													<a href="<?php echo base_url(ADMIN_URL) ?>app/single-user/activate/<?php echo $app->appSlug; ?>" class="delete"><i class="fa fa-check"></i></a> 
												<?php else: ?>
													<a href="<?php echo base_url(ADMIN_URL) ?>app/single-user/deactivate/<?php echo $app->appSlug; ?>" title="Block App" class="delete"><i class="fa fa-times"></i></a> 
												<?php endif; ?>
											| <?php if($app->isLocked): ?>
													<a href="<?php echo base_url(ADMIN_URL) ?>app/single-user/unlock/<?php echo $app->appSlug; ?>" class="delete"><i class="fa fa-unlock"></i></a> 
												<?php else: ?>
													<a href="<?php echo base_url(ADMIN_URL) ?>app/single-user/lock/<?php echo $app->appSlug; ?>" title="Block App" class="delete"><i class="fa fa-lock"></i></a> 
												<?php endif; ?>
										</td>
									</tr>
								<?php }
