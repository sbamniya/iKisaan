...
class Template
{
    ...
    function load($tpl_view, $body_view = null, $data = null) 
    {
        if ( ! is_null( $body_view ) ) 
        {
            ...
            {
                $body_view_path = 'admin/'.$tpl_view.'/'.$body_view;
            }
            else if ( file_exists( APPPATH.'views/admin/'.$tpl_view.'/'.$body_view.'.php' ) ) 
            {
                $body_view_path = 'admin/'.$tpl_view.'/'.$body_view.'.php';
            }
            ...
            {
                show_error('Unable to load the requested file: ' . $tpl_name.'/'.$body_view.'.php');
            }
        ...
        $this->ci->load->view('admin/templates/'.$tpl_view, $data);
    }
    function loadFront($tpl_view, $body_view = null, $data = null) 
    {
        if ( ! is_null( $body_view ) ) 
        {
